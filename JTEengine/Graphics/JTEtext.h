...
public:
    ...
    * @brief This draws the first 1024 characters of the file. Uses a font glyph atlas
    * 
    ...
    * @param style - (0 is normal, 1 is italics) if you want bold then use a bold font ttf file.
    */
	JTEtext(const char* fontFile, int fontSize, JTEwindow* window, int style = 0);
    ...
    /*
    * @brief Renders text
    * @brief Text unlike other renders (basic shapes, images), render bottom left aligned instead of top left aligned.
    * 
